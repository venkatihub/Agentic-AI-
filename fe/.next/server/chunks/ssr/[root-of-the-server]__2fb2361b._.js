...
function Home() {
    ...
    function handleGenerateRealtime() {
        if (!command.trim()) return;
        const sessionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
        setHtml('');
        setStatus('Opening WebSocket …');
        wsRef.current?.close();
        wsRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateUIStream"])(command, sessionId, (msg)=>{
            switch(msg.type){
                case 'status':
    ...
    async function handleSave() {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveTemplate"])({
                html,
    ...
    async function loadAnalytics() {
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAnalytics"])();
            setAnalytics(data);
        } catch (e) {
            alert(e.message);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fb2361b._.js.map