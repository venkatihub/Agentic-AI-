...
function Home() {
    ...
    function handleGenerateRealtime() {
        var _wsRef_current;
        if (!command.trim()) return;
        const sessionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
        setHtml('');
        setStatus('Opening WebSocket …');
        (_wsRef_current = wsRef.current) === null || _wsRef_current === void 0 ? void 0 : _wsRef_current.close();
        wsRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateUIStream"])(command, sessionId, (msg)=>{
            switch(msg.type){
                case 'status':
                ...
                case 'result':
                    ...
                    setStatus("Done in ".concat((msg.processing_time || 0).toFixed(2), "s"));
                    (_wsRef_current = wsRef.current) === null || _wsRef_current === void 0 ? void 0 : _wsRef_current.close();
                    break;
                case 'error':
                    var _wsRef_current1;
                    setStatus(msg.message);
                    (_wsRef_current1 = wsRef.current) === null || _wsRef_current1 === void 0 ? void 0 : _wsRef_current1.close();
                    break;
            }
        }, (err)=>{
            setStatus('WS error');
    ...
    async function handleSave() {
        try {
            var _validation_confidence_score;
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveTemplate"])({
                html,
                parent_template_id: templateId,
                user: 'demo-user',
                confidence_score: validation === null || validation === void 0 ? void 0 : (_validation_confidence_score = validation.confidence_score) === null || _validation_confidence_score === void 0 ? void 0 : _validation_confidence_score.overall
            });
            alert("saved as ".concat(res.template_id));
        } catch (e) {
            alert(e.message);
        }
    }
    async function loadAnalytics() {
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAnalytics"])();
            setAnalytics(data);
        } catch (e) {
            alert(e.message);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                children: "AI Web-Block Generator (Next JS)"
            }, void 0, false, {
            ...
            validation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    ((_validation_warnings = validation.warnings) === null || _validation_warnings === void 0 ? void 0 : _validation_warnings.length) > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: validation.warnings.join(', ')
                    }, void 0, false, {
                        fileName: "[project]/src/app/page.tsx",
                        lineNumber: 138,
                        columnNumber: 13
...
_s(Home, "Vv2vXz+eI+odGpgZ74ISSkKIzSw=");
_c = Home;
var _c;
...
//# sourceMappingURL=_d913c621._.js.map